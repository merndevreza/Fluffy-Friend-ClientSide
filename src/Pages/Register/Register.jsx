...
const Register = () => { 
   ...
   return (
    ...
    <div className="absolute left-0 top-0 w-full h-full bg-theme-black dark:opacity-90 opacity-0"></div>
        <div className="dark:bg-theme-black bg-white max-w-3xl mx-auto px-6 md:px-12 py-10 md:py-20 relative z-20">
        ...
        <div className="mt-8  dark:bg-theme-black relative z-20 bg-white  max-w-3xl mx-auto md:px-12 px-6 py-6 md:py-14 flex flex-col md:flex-row justify-between items-center gap-4">
          ...
          <Link to="/login">
            <button className="btn rounded-full  border-none bg-theme-black dark:bg-white dark:text-theme-black dark:hover:bg-theme-yellow hover:bg-theme-yellow hover:text-theme-black  text-white text-xl px-8">Login</button>
          </Link>
        </div>
      </div>
   );
