...
const AboutUs = () => {
  return (
    <div className="bg-theme-dark py-24 px-2">
      <div className=" flex flex-col xl:flex-row justify-center gap-10 container mx-auto ">
        <div className="xl:w-full flex justify-center">
          <img className="h-[300px] md:h-[400px] xl:h-[600px]" src={aboutImg} alt="Fluffy Friend" />
        </div>
        <div className="w-full text-center xl:text-left">
          <h4 className="text-2xl text-theme-yellow">About Us</h4>
          <h2 className=" text-3xl md:text-4xl font-semibold text-white mt-4 mb-8">
          ...
          <ul className="text-lg md:text-xl  text-left space-y-2 xl:space-y-5 text text-white mb-10">
            <li className="flex gap-2">
              <div className="mt-2  h-7 bg-theme-yellow rounded-full p-1">
              <IoMdPaw />
              </div>
              We are a nonprofit animal welfare organization.
            </li>
            <li className="flex gap-2  ">
             <div className="mt-2  bg-theme-yellow rounded-full p-1 h-7">
             <IoMdPaw />
             </div>
